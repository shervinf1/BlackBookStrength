        ...
        docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot snapshot, @Nullable FirebaseFirestoreException e) {
                ...
                if (snapshot != null && snapshot.exists()) {
                    ...
                    mainLiftCollectionReference.add(new MainLiftPOJO(benchMax * MainLiftPOJO.PERCENT_60,"lbs",60, "% x 1 REPS"));
                    mainLiftCollectionReference.add(new MainLiftPOJO(benchMax * MainLiftPOJO.PERCENT_75,"lbs",75, "% x 5 REPS"));
                    mainLiftCollectionReference.add(new MainLiftPOJO(benchMax * MainLiftPOJO.PERCENT_85,"lbs",85, "% x 3 REPS"));
                    mainLiftCollectionReference.add(new MainLiftPOJO(benchMax * MainLiftPOJO.PERCENT_95,"lbs",95, "% x 1 REPS"));
