        ...
        docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot snapshot, @Nullable FirebaseFirestoreException e) {
                ...
                if (snapshot != null && snapshot.exists()) {
                    ...
                    MainLiftPOJO Lift;
                    Lift = new MainLiftPOJO(squatMax * MainLiftPOJO.PERCENT_40,"lbs", 40, "% x 5 REPS");
                    mArrayList.add(Lift);
                    Lift = new MainLiftPOJO(squatMax * MainLiftPOJO.PERCENT_50,"lbs",50, "% x 5 REPS");
                    mArrayList.add(Lift);
                    Lift = new MainLiftPOJO(squatMax * MainLiftPOJO.PERCENT_60,"lbs",60, "% x 5 REPS");
                    mArrayList.add(Lift);
                    Lift = new MainLiftPOJO(squatMax * MainLiftPOJO.PERCENT_65,"lbs",65, "% x 5 REPS");
                    mArrayList.add(Lift);
                    Lift = new MainLiftPOJO(squatMax * MainLiftPOJO.PERCENT_75,"lbs",75, "% x 5 REPS");
                    mArrayList.add(Lift);
                    Lift = new MainLiftPOJO(squatMax * MainLiftPOJO.PERCENT_85,"lbs",85, "% x 5 REPS");
                    mArrayList.add(Lift);
