...
public class Week3Fragment extends Fragment {
    ...
    private void getCheckedFromFirestore(View view,final Week1Fragment.MyCallback myCallback) {
        ...
        collectionNameList.add("deadliftWeek3");
        collectionNameList.add("benchWeek3");
        collectionNameList.add("squatWeek3");
        collectionNameList.add("ohpWeek3");
            ...
            db.collection("users").document(userID).collection(collectionNameList.get(i))
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        Log.d("Week3F", "Error getting documents: ", task.getException());
                    }
                }
            });
        }
