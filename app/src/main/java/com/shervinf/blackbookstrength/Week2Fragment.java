...
public class Week2Fragment extends Fragment {
    ...
    private void getCheckedFromFirestore(View view,final Week1Fragment.MyCallback myCallback) {
        ...
        collectionNameList.add("deadliftWeek2");
        collectionNameList.add("benchWeek2");
        collectionNameList.add("squatWeek2");
        collectionNameList.add("ohpWeek2");
            ...
            db.collection("users").document(userID).collection(collectionNameList.get(i))
                ...
                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                    if (task.isSuccessful()) {
                        ...
                        Log.d("Week2F", "Error getting documents: ", task.getException());
                    }
                }
            });
        }
    ...
    private void recyclerViewSetup(){
        RecyclerView mRecyclerView2 = getView().findViewById(R.id.recyclerViewWeek);
        Log.d("aaaaa", mArrayList + "");
