...
public class BenchActivityWeek2 extends AppCompatActivity {
    private FirebaseFirestore db =FirebaseFirestore.getInstance();
    private String userID = FirebaseAuth.getInstance().getCurrentUser().getUid();
    private CollectionReference mainLiftCollectionReference = db.collection("users").document(userID).collection("benchWeek2");
        ...
        docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot snapshot, @Nullable FirebaseFirestoreException e) {
                ...
                if (snapshot != null && snapshot.exists()) {
                    ...
                    mainLiftCollectionReference.add(new MainLiftPOJO(benchMax * MainLiftPOJO.PERCENT_40,"lbs", 40, "% x 3 REPS"));
                    mainLiftCollectionReference.add(new MainLiftPOJO(benchMax * MainLiftPOJO.PERCENT_50,"lbs",50, "% x 3 REPS"));
                    mainLiftCollectionReference.add(new MainLiftPOJO(benchMax * MainLiftPOJO.PERCENT_60,"lbs",60, "% x 3 REPS"));
                    mainLiftCollectionReference.add(new MainLiftPOJO(benchMax * MainLiftPOJO.PERCENT_70,"lbs",70, "% x 3 REPS"));
                    mainLiftCollectionReference.add(new MainLiftPOJO(benchMax * MainLiftPOJO.PERCENT_80,"lbs",80, "% x 3 REPS"));
                    mainLiftCollectionReference.add(new MainLiftPOJO(benchMax * MainLiftPOJO.PERCENT_90,"lbs",90, "% x 3 REPS"));
