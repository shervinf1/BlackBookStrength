        ...
        docRef.addSnapshotListener(new EventListener<DocumentSnapshot>() {
            ...
            public void onEvent(@Nullable DocumentSnapshot snapshot, @Nullable FirebaseFirestoreException e) {
                ...
                if (snapshot != null && snapshot.exists()) {
                    ...
                    mArrayList.add(Lift);
                    Lift = new MainLiftPOJO(ohpMax * MainLiftPOJO.PERCENT_60,"lbs",60, "% x 1 REPS");
                    mArrayList.add(Lift);
                    Lift = new MainLiftPOJO(ohpMax * MainLiftPOJO.PERCENT_75,"lbs",75, "% x 5 REPS");
                    mArrayList.add(Lift);
                    Lift = new MainLiftPOJO(ohpMax * MainLiftPOJO.PERCENT_85,"lbs",85, "% x 3 REPS");
                    mArrayList.add(Lift);
                    Lift = new MainLiftPOJO(ohpMax * MainLiftPOJO.PERCENT_95,"lbs",95, "% x 1 REPS");
                    mArrayList.add(Lift);
